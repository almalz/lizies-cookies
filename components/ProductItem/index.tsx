...
export const ProductItem: React.FC<ProductItemProps> = ({ product }) => {
  ...
  return (
    <div className="border-1 flex items-center border border-purple-700 sm:h-[35rem] sm:flex-col sm:p-2">
      <button
        className="relative m-1 aspect-square h-40 w-40 sm:m-0 sm:h-96 sm:w-full"
      ...
      <div className="flex h-full w-full flex-col py-2 px-4 sm:py-4">
        <button
          className="flex-1 text-left text-purple-700 hover:opacity-30 sm:p-2"
          onClick={() => openProductModal()}
        >
